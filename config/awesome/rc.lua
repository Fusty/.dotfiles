...
local awesompd = require("awesompd/awesompd")
  ...
  musicwidget.path_to_icons = "/home/ktr/.config/awesome/awesompd/icons" 
...
globalkeys = awful.util.table.join(
    -- press Impécr Syst key to get a full screenshot
    awful.key({           }, "Print",   function() awful.util.spawn("scrot '%y%m%d_scrot_$wx$h.png' -e 'mv $f ~/Desktop/'") end),
    -- pause button
    -- TODO
  ...
  --  awful.key({ modkey, "Shift"   }, "t", function () awful.client.swap.byidx(  1)    end),
    ...
    -- ktr disable because it brings black screen
